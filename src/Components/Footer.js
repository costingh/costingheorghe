                        ...
                        <div className="social-container d-flex justify-content-center">
                            <div className="social-wrapper">
                                ...
                                >
                                    <svg
                                        style={{
                                            filter: 'invert(70%) sepia(40%) saturate(668%) hue-rotate(127deg) brightness(81%) contrast(89%)',
                                        }}
                            ...
                            <div className="social-wrapper">
                                <a
                                    href="https://github.com/costingh"
                                    target="_blank"
                                    title="Github"
                                    style={{
                                        display: 'flex',
                            ...
                            <div className="social-wrapper">
                                <a
                                    href="https://www.linkedin.com/in/gheorghe-constantin-silvian-a388a7193/"
                                    target="_blank"
                                    title="Linkedin"
                                    style={{
                                        display: 'flex',
